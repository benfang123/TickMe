    ...
    <div class="box">
      <div class="list">
        ...
        <div class="colors">
          ...
          <div class="color-list" @click="changeTheme('darkly')">
            <div class="color-info darkly">暗<br>黑</div>
            <svg-icon v-if="theme == 'darkly'" icon-class="icon-check"></svg-icon>
          </div>
...
.color-list:nth-of-type(5) {
  background-image: linear-gradient(to bottom right, #696969, #4F4F4F);
  box-shadow: 0 0 16px 0 rgba(124, 45, 18, .4) inset;
  box-shadow: 0 0 0 0 #FED7AA;
}
.color-list:hover {
